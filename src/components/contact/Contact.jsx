...
const addressData = [
  {
    icon: faLocationDot,
    title: "Address",
    description: "Bangkalan-East Java, 69162",
  },
  {
    icon: faEnvelope,
    title: "My Email",
    description: "10mohnaufal.thariq@mail.com",
  },
  {
    icon: faPhone,
    title: "Call Me Now",
    description: "0878-5080-2252",
  },
];
          ...
          <div>
            <div>
              ...
              <p className="text-[12px] xs:text-[14px] sm:text-lg md:text-lg max-lg:text-center pt-4 font-normal text-soft-dark">
                  I'm open to internship opportunities where I can apply and further develop my
  skills in Artificial Intelligence and Computer Vision.
              </p>
            </div>
